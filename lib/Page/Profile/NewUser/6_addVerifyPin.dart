...
class AddVerifyPin extends StatefulWidget {
  ...
  @override
  State<AddVerifyPin> createState() => _AddVerifyPinState();
}

class _AddVerifyPinState extends State<AddVerifyPin> {
  @override
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  pinIndexSetup(String text) {
    ...
    if (pinIndex == 6) {
      validation(veriPin, widget.oldPin);
    }
  }
