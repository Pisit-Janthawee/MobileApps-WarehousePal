...
class ForgetPin_ConfirmChangeNewPinPage extends StatefulWidget {
  final Profile profile;
  final String newPin;

  const ForgetPin_ConfirmChangeNewPinPage({
    Key? key,
  ...
  @override
  State<ForgetPin_ConfirmChangeNewPinPage> createState() =>
      _ForgetPin_ConfirmChangeNewPinPageState();
}

class _ForgetPin_ConfirmChangeNewPinPageState
    extends State<ForgetPin_ConfirmChangeNewPinPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: OtpScreen(profile: widget.profile, newPin: widget.newPin),
      ),
    );
  }
}
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  pinIndexSetup(String text) {
    ...
    if (pinIndex == 6) {
      validation(veriPin, widget.newPin);
    }
  }

  Future addProfile(pin) async {
    await DatabaseManager.instance.updateProfile(widget.profile.copy(pin: pin));
