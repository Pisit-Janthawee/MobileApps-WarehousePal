...
class ChangeNewPinPage extends StatefulWidget {
  ...
  @override
  State<ChangeNewPinPage> createState() => _ChangeNewPinPageState();
}

class _ChangeNewPinPageState extends State<ChangeNewPinPage> {
  void initState() {
    super.initState();
  }
  ...
  pinIndexSetup(String text) {
    ...
    if (pinIndex == 6) {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ConfirmChangeNewPinPage(
