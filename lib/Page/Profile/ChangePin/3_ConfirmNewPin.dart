...
class ConfirmChangeNewPinPage extends StatefulWidget {
  final Profile profile;
  final String newPin;

  const ConfirmChangeNewPinPage({
    Key? key,
  ...
  @override
  State<ConfirmChangeNewPinPage> createState() =>
      _ConfirmChangeNewPinPageState();
}

class _ConfirmChangeNewPinPageState extends State<ConfirmChangeNewPinPage> {
  @override
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future addProfile(pin) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      content: Text("เปลี่ยน PIN ใหม่เสร็จ!"),
